...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartResult<T>);
}
...
/// @nodoc
class $CartResultCopyWith<T,$Res>  {
$CartResultCopyWith(CartResult<T> _, $Res Function(CartResult<T>) __);
}


/// Adds pattern-matching-related methods to [CartResult].
extension CartResultPatterns<T> on CartResult<T> {
...
class Success<T> implements CartResult<T> {
   Success(this.data);
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CartResultCopyWith<T, $Res> {
...
class Error<T> implements CartResult<T> {
   Error(this.message);
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CartResultCopyWith<T, $Res> {
