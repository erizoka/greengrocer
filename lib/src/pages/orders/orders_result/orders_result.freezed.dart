...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrdersResult<T>);
}
...
/// @nodoc
class $OrdersResultCopyWith<T,$Res>  {
$OrdersResultCopyWith(OrdersResult<T> _, $Res Function(OrdersResult<T>) __);
}


/// Adds pattern-matching-related methods to [OrdersResult].
extension OrdersResultPatterns<T> on OrdersResult<T> {
...
class Success<T> implements OrdersResult<T> {
   Success(this.data);
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $OrdersResultCopyWith<T, $Res> {
...
class Error<T> implements OrdersResult<T> {
   Error(this.message);
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $OrdersResultCopyWith<T, $Res> {
